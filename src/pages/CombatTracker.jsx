  ...
  return (
    <div className="flex neumorphic" style={{ height: 'calc(100vh - 48px)' }}>
      ...
      <div className={`flex-1 flex flex-col min-w-0 ${isMobile && mobileTab === 'library' ? 'hidden' : ''}`}>
        ...
        {/* Toolbar */}
        <div className="shrink-0 px-5 py-2.5 border-b border-white/[0.04] flex items-center gap-3 min-h-[48px]">
          <button
            onClick={() => {
            ...
            className="btn-neon-gold !text-sm !px-4 !py-2"
          >
            ⚔ Roll Initiative
          </button>
          ...
          {showClearConfirm ? (
            <div className="flex items-center gap-2">
              <span className="text-sm text-[#8a8884]">Clear all?</span>
              <button
        ...
        {combat.combatants.length > 0 && (
          <div className="lg:hidden shrink-0 flex items-center gap-2 px-3 mx-3 py-1.5 border-b border-white/[0.04] text-[10px] uppercase tracking-wider font-medium" style={{ color: 'var(--text-subtle)', letterSpacing: '0.07em' }}>
            <div className="w-7 shrink-0 text-center">#</div>
            <div className="flex-1 min-w-0 flex items-center gap-2">
              <span className="w-[100px] shrink-0">Name</span>
              <span className="shrink-0 w-7 text-center">AC</span>
              <span className="shrink-0 w-[72px] text-center">HP</span>
            </div>
          ...
          <div className="max-lg:hidden shrink-0 grid grid-cols-[36px_1fr_2fr_auto] items-center pl-[22px] pr-[6px] py-1 mx-3 border-b border-white/[0.04] mb-[3px]" style={{ color: 'var(--text-subtle)', fontSize: '10px', letterSpacing: '0.07em', textTransform: 'uppercase', fontWeight: 500 }}>
            ...
            <div className="flex items-center gap-[6px]">
              <div className="flex items-center justify-center gap-[6px] w-[120px]">
                ...
                <div className="w-[30px] text-center">AC</div>
              </div>
            </div>
            <div style={{ width: 84 }} />
          </div>
          ...
          >
            ...
            >
              {combat.combatants.map((c, idx) => (
                <Fragment key={c.id}>
                  {idx > 0 && <div className="row-divider max-lg:hidden" />}
                <CombatantRow
                  combatant={c}
