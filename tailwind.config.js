  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Neumorphic shadows
        'neu-raised': '7px 7px 18px #111111, -4px -4px 12px #363636',
        'neu-raised-sm': '2px 2px 5px #111111, -1px -1px 4px #303030',
        'neu-pressed': 'inset 3px 3px 8px #101010, inset -2px -2px 6px #252525',
        'neu-pressed-deep': 'inset 3px 3px 8px #101010, inset -2px -2px 6px #252525',
        'neu-flat': '2px 2px 5px #111111, -1px -1px 4px #303030',
        'neu-glow-orange': 'inset 0 0 8px rgba(255,107,53,0.2), 2px 2px 5px #111111, -1px -1px 4px #303030',
        'neu-glow-blue': 'inset 0 0 8px rgba(96,165,250,0.2), 2px 2px 5px #111111, -1px -1px 4px #303030',
        'neu-glow-red': 'inset 0 0 8px rgba(248,113,113,0.15), 2px 2px 5px #111111, -1px -1px 4px #303030',
        'neu-glow-green': 'inset 0 0 8px rgba(74,222,128,0.15), 2px 2px 5px #111111, -1px -1px 4px #303030',
      },
    },
  },
  plugins: [
