  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Neumorphic shadows
        'neu-raised': '3px 3px 6px #0e0e0e, -3px -3px 6px #5f5e5e, inset 0px 0px 0px #0e0e0e, inset 0px 0px 0px #5f5e5e',
        'neu-raised-sm': '2px 2px 4px #0e0e0e, -2px -2px 4px #5f5e5e, inset 0px 0px 0px #0e0e0e, inset 0px 0px 0px #5f5e5e',
        'neu-pressed': '0px 0px 0px #0e0e0e, 0px 0px 0px rgba(95, 94, 94, 0.25), inset 3px 3px 4px #0e0e0e, inset -3px -3px 4px #5f5e5e',
        'neu-pressed-deep': '0px 0px 0px #0e0e0e, 0px 0px 0px rgba(95, 94, 94, 0.25), inset 3px 3px 6px #0e0e0e, inset -3px -3px 6px #5f5e5e',
        'neu-flat': '1.5px 1.5px 3px #0e0e0e, -1.5px -1.5px 3px #5f5e5e, inset 0px 0px 0px #0e0e0e, inset 0px 0px 0px #5f5e5e',
        'neu-glow-orange': 'inset 0 0 8px rgba(255,107,53,0.2), 3px 3px 6px #0e0e0e, -3px -3px 6px #5f5e5e',
        'neu-glow-blue': 'inset 0 0 8px rgba(96,165,250,0.2), 3px 3px 6px #0e0e0e, -3px -3px 6px #5f5e5e',
        'neu-glow-red': 'inset 0 0 8px rgba(248,113,113,0.15), 2px 2px 4px #0e0e0e, -2px -2px 4px #5f5e5e',
        'neu-glow-green': 'inset 0 0 8px rgba(74,222,128,0.15), 2px 2px 4px #0e0e0e, -2px -2px 4px #5f5e5e',
      },
    },
  },
  plugins: [
